...
## 5.3 線上購物
![ERD本系統購物流程圖](./docs/shop.png)
圖5.3：本系統購物流程圖。

當使用者決定將商品加入購物車時，系統會根據商品ID在MongoDB查詢商品資訊。若該商品已存在於使用者的購物車，系統會更新其數量。若尚未加入，則會在新增一筆對應的商品項目。同時，使用者也可以在購物車調整各商品的數量。

使用者決定購買時，系統會根據購物車的商品項目計算總金額，並提供會員卡和信用卡兩種付款方式。

會員卡：系統會建立一筆交易紀錄、更新會員卡餘額和清空購物車。

信用卡：系統會建立一筆「待付款」的交易紀錄，之後會和STRIPE確認付款狀態，如果付款成功會更新交易紀錄的付款狀態並且清空購物車；若付款未完成，則不更新資料，購物車內容維持原狀。
